...
final class MainPageVC: UIViewController {
    ...
    let mockData: [Dish] =
    [
        Dish(name: "Furkan", price: "12₺", image: UIImage(systemName: "car")!, isSold: false),
        Dish(name: "Ali", price: "22₺", image: UIImage(systemName: "folder")!, isSold: false),
        Dish(name: "Veli", price: "32₺", image: UIImage(systemName: "car")!, isSold: false),
        Dish(name: "Osman", price: "42₺", image: UIImage(systemName: "folder")!, isSold: false),
        Dish(name: "Ahmet", price: "52₺", image: UIImage(systemName: "car")!, isSold: false),
        Dish(name: "Mehmet", price: "62₺", image: UIImage(systemName: "car")!, isSold: false),
        Dish(name: "Kaan", price: "42₺", image: UIImage(systemName: "folder")!, isSold: false),
        Dish(name: "Selma", price: "52₺", image: UIImage(systemName: "car")!, isSold: false),
        Dish(name: "Ahmet", price: "62₺", image: UIImage(systemName: "car")!, isSold: false),
...
//        collectionView.backgroundColor = .systemBlue
    ...
    func createThreeColumnFlowLayout() -> UICollectionViewFlowLayout {
        ...
        let availableWidth = width - (padding * 2) - (minimumItemSpacing * 2) // ekranın sağından ve solunda bosluklar ik itane diye padding * 2 yaptım
    ...
    func configureDataSource() {
        dataSource = UICollectionViewDiffableDataSource<Section, Dish>(collectionView: collectionView, cellProvider: { collectionView, indexPath, itemIdentifier in
            ...
            cell.set(dish: Dish(name: "Denem", price: "12", image: UIImage(systemName: "car")!, isSold: false))
            return cell
        })
    }
