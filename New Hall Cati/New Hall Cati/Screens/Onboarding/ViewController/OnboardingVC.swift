...
final class OnboardingVC: UIViewController {
    ...
    private func sendUserToMainPage() {
...
extension OnboardingVC: UITextFieldDelegate {
    ...
    private func handleTextField() {
        self.adminNumberTextField.text = ""
        self.adminNumberTextField.resignFirstResponder()
    }
...
extension OnboardingVC: OnboardingViewControllable {
    ...
    func didCatchError() {
        self.stopLoadingView()
        AlertMessage.shared.showAlertMessage(
            title: "Hata ",
            subtitle: "Giriş işlemi başarısız oldu. Lütfen tekrar deneyin 👋",
            viewController: self
        )
    }
}
